<!------- COMMUNITY SECTION 
// VIIMASED 5tk KÜSIMUSED JA REVIEWD
...
if( $post_object ): 
	...
	?>
     ...
     <?php endwhile; endif; ?>
</div><!-- community_slider -->
				<a href="http://stg.casberry.eu/weedrepublic/community/"><?php _e('Show all community posts/questions... >','customtext');?></a>
